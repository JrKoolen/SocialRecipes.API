  ...
  <div>
    ...
    <div class="adminpanel-grid">
      <div class="adminpanel-box">
        ...
        />
        <button @click="fetchUser" class="adminpanel-button">Get User</button>
        <p v-if="userDetails">User: {{ userDetails.name }}</p>
      ...
      <div class="adminpanel-box">
        ...
        <input
          ...
          class="adminpanel-input"
        />
        <button @click="fetchRecipe" class="adminpanel-button">Get Recipe</button>
        <p v-if="recipeDetails">Recipe: {{ recipeDetails.Title }}</p>
...
<script>
import { delUserFromId, delRecipeFromId, getUserById, getRecipeById } from "../services/api"; 
...
methods: {
  ...
  async fetchRecipe() {
    ...
    try {
      const response = await getRecipeById(this.recipeId);
